...
| category (professional account) | Software company |
| avatar | `marketing/brand/pyre/pfp.png` (1024×1024; the mark on obsidian, heat spilling onto the floor). Fallback `marketing/brand/pyre/pfp-alt.png` if the mark reads too small at 48px. |
| header | `marketing/brand/pyre/banner.png` (1500×500; bottom-left 420×180 is clear for the avatar, proven by `banner-safe-preview.png`) |
| pinned | `posts/pinned.md` (quote of the article). Replace with the $PYRE launch post once the coin is live. |
