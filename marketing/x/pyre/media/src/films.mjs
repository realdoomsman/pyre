  ...
  loop: {
    ...
    shots: [
      ...
      { id: "coin-cap", base: 5.8, cap: "coin", focal: [0.5, 0.5], sqfocal: [0.42, 0.5], zoom: [1.12, 1.22], caption: CAPTION.mock,
        sentences: [{ text: "the app is free to use. 25% of every fee buys PYRE and burns it.", say: "The app is free to use. Twenty-five percent of every fee buys Pyre and burns it." }] },
      { id: "close", base: 3.6, lead: 0.7, sentences: [{ text: "supply falls because the coin traded.", say: "Supply falls because the coin traded." }] },
    ],
  },
  ...
  burn: {
    ...
    shots: [
      ...
      { id: "hash", base: 6.2, lead: 0.5,
        sentences: [{ text: "the hash is sha256 of the fee entry ids behind the burn. the burn ledger shows it next to the tx.", say: "The hash is sha-256 of the fee entry ids behind the burn. The burn ledger shows it next to the transaction." }] },
